...
$csrf = csrfToken();
$pageTitle = 'افزودن اکانت (کامل)';
require __DIR__ . '/../../includes/header.php';
?>
<div class="d-flex justify-content-between align-items-center mb-4">
    <h1 class="h4 mb-0">افزودن اکانت — فرم کامل</h1>
    <div class="d-flex gap-2">
        <a href="quick-add.php" class="btn btn-outline-secondary btn-sm">افزودن سریع</a>
    ...
    <div class="card am-card mb-3">
        ...
        <div class="card-body row g-3">
            ...
            <div class="col-md-4">
                ...
                <input type="text" name="credential_storage" class="form-control" value="<?= e($form['credential_storage']) ?>" placeholder="مثلاً KeePass">
            </div>
            <div class="col-md-4">
                <label class="form-label">مرجع Credential</label>
                <input type="text" name="credential_reference" class="form-control" value="<?= e($form['credential_reference']) ?>" placeholder="مثلاً GitHub / Work">
            </div>
            <div class="col-12">
    ...
    <div class="card am-card mb-3">
        ...
        <div class="card-body row g-3">
            ...
            <div class="col-md-6">
                ...
                <input type="text" name="recovery_contact" class="form-control" value="<?= e($form['recovery_contact']) ?>" placeholder="مثلاً فردی غیر از ایمیل/تلفن">
            </div>
            <div class="col-md-3">
